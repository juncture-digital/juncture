  ...
  if is_v2:
    ...
    if not footer:
      ...
      footer.append(BeautifulSoup('''
        <ul>
          <li><a href="https://juncture-digital.org">Powered by: <img alt="" src="https://www.juncture-digital.io/juncture/static/images/juncture-logo.png"/></a></li>
          <li>view-code</li>
        </ul>''', 
      'html5lib'))
    main.append(footer)
...
def j1_md_to_html(src, **args):
  ...
  if env == 'local':
    ...
    template = template.replace('https://www.juncture-digital.io/juncture/static/v1.js', f'/static/v1.js?cachebuster={time.time()}')
  else:
...
def j2_md_to_html(src, **args):
  ...
  if env == 'local':
    ...
    if env == 'dev':
      template = template.replace('https://cdn.jsdelivr.net/npm/juncture-digital/docs', 'https://www.juncture-digital.io/web-components')
    else: # prod
  ...
  if prefix == 'juncture-digital/juncture':
    ...
    if path_root in ('index', 'editor', 'media'):
      ...
      if env == 'local':
        ...
        content = content.replace('https://cdn.jsdelivr.net/npm/juncture-digital/docs', 'https://www.juncture-digital.io/web-components')
      else: # prod

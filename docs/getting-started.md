...
This Getting Started guide provides step-by-step instructions and examples for creating a Juncture essay on the painting "Bedroom in Arles" by Vincent van Gogh.  The text we'll be using for this sample essay was obtained from [Wikipedia](https://en.wikipedia.org/wiki/Bedroom_in_Arles).
...
<ve-modal src="juncture-digital/juncture/examples/bedroom-in-arles/plain-text"></ve-modal>

<ve-snippet collapsible label="Plain text for our 'Bedroom in Arles' sample essay">
    Bedroom in Arles
...
In the example below, Markdown tags have been added to the plain text to create a link, add a horizontal line, create a section heading and format paragraph text with bold and italicized passage. 

<ve-modal src="juncture-digital/juncture/examples/bedroom-in-arles/with-markdown"></ve-modal>
...
In cases where content is reused from another source it is a best practice to cite the original source with a footnote (technically, an endnote).  The core Markdown language does not include a footnote tag but most of the Markdown implementations provide an extension for this, including the Markdown parser used by Juncture.

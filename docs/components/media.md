...
Below is the full list of popular image hosting sites that is supported by Juncture to automatically create IIIF Manifests and their corresponding short form site code.
* cc - OpenVerse
* edison - Rutgers Edison Papers Project
* flickr - Flickr
* gh - Github
* harvard - Harvard Art Museum
* ia - Internet Archive
* jstor - JSTOR Community Collections
